...
const OxygenGauge: React.FC<GaugeProps> = ({ radius, percent = 0 }) => {
    ...
    return (
        <div style={{ position: 'absolute', bottom: 0, left: '40%', transform: 'translateX(-50%)', color: 'white' }}>
            ...
            <img src={OxygenIcon} alt="icon" style={{
                position: 'absolute',
                top: '50%',
                left: '50%',
